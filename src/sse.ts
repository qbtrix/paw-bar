...
// Created: 2026-07-14 (Paw Bar chat UI, T4) — feed it decoded response chunks via
//   push(); it buffers partial frames across chunk boundaries, normalizes CRLF,
//   splits on the blank-line frame delimiter, and returns complete SseFrames.
//   Matches the wire shape ee/paw_bar/router.py `_sse` writes: `event: <name>\n`,
